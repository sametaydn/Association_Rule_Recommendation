...
df_ = pd.read_csv("Modül_4_Tavsiye_Sistemleri/Armut ARL/armut_data.csv")
df = df_.copy()
df.head()
...
# 2017’in 10.ayında aldığı  9_4, 38_4  hizmetleri başka bir sepeti ifade etmektedir. Sepetleri unique bir ID ile tanımlanması
# gerekmektedir.
# Bunun için öncelikle sadece yıl ve ay içeren yeni bir date değişkeni oluşturunuz. UserID ve yeni oluşturduğunuz
